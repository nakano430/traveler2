        ...
        <ul>
            <form method="POST" action="/password_reset_send">
                ...
                <li>
                    ...
                    <p class="error-message">&ensp;{{ $errors->first('now_password') }}</p>
                    @endif
                ...
                <li>
                    ...
                    <p class="error-message">&ensp;{{ $errors->first('new_password1') }}</p>
                    @endif
                </li>
                <!--6-->
                ...
                <li>
                    ...
                    <p class="error-message">&ensp;{{ $errors->first('new_password2') }}</p>
                    @endif
                </li>
                <!--8-->
