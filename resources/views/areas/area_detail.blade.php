...
<body>
    ...
    <div>
        <h1 class="detail_title">{{ $area_info->name }}</h1>
        <table class="detail_category">
            <tr>
                <td><img class="hotel_picture" src="img/touristarea/{{ $area_info->english_name }}.jpg"></td>
                <td class="detail_delimiter"></td>
                <td class="area_detail">
                    <h2>● 観光地詳細</h2>
                    <h3><i class="fa-solid fa-location-dot">&emsp;{{ $area_info->address }}</i></h3>
                    <h3><i class="fa-solid fa-phone">&emsp;{{ $area_info->genre }}</i></h3>
                    <h3><i class="fa-solid fa-money-check-dollar">&emsp;{{ $area_info->detail }}</i></h3>
