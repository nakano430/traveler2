...
<div class="profile_complete_category">
    <form method="POST" action="/hotel_list">
        <ul>
        <?php echo csrf_field(); ?>
            <li><h2>ホテル情報の変更完了</h2></li>
            <li></li>
            <li>
                ホテル情報の変更が完了致しました。<br>
                "ホテル情報一覧へ戻る"ボタンにてお戻りください。
            </li>
            <li><button type="submit" class="back_login_button">ホテル情報一覧へ戻る</button></li>
...
</html><?php /**PATH /Applications/MAMP/htdocs/traveler/resources/views/administrator/hotel_edit_complete.blade.php ENDPATH**/ ?>