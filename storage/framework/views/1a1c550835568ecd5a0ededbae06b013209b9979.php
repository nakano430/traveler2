...
<body>
    ...
    <div class="profile_confirm_category">
        <ul>
            <form method="post" action="/profile_complete">
                <?php echo csrf_field(); ?>
                <li>※変更内容をご確認ください※</li>
                <!--2-->
                <li></li>
...
</html><?php /**PATH C:\xampp\htdocs\Travel\resources\views/mypage/profile_confirm.blade.php ENDPATH**/ ?>