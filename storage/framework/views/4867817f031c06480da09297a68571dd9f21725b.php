            ...
            <table class="detail_category">
                <tr>
                    ...
                    <td class="area_detail">
                        ...
                        <p>&emsp;・
                            <input type="text" name="roomtype" class="input_box_roomtype" value="<?php echo e($room->roomtype); ?>">
                            &emsp;/&emsp;<input type="text" name="price" class="input_box_roomtype" value="<?php echo e($room->price); ?>">
                            円</p>
...
</html><?php /**PATH C:\xampp\htdocs\traveler\traveler\resources\views/administrator/hotel_edit.blade.php ENDPATH**/ ?>