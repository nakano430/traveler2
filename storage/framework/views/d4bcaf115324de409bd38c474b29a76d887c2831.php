    ...
    <div>
        ...
        <form method="POST" action="/touristarea_edit_complete">
            ...
            <h1 class="detail_title">
                <input type="text" name="touristarea_name" class="name_box" value="<?php echo e($results->name); ?>">
            </h1>
            <?php if($errors->has('name')): ?>
            <br>
            <p class="error-message"><?php echo e($errors->first('name')); ?></p>
            <?php endif; ?><table class="detail_category">
                <tr>
                    ...
                    <td class="area_detail">
                        ...
                        <h3><i class="fa-solid fa-location-dot">&emsp;<input type="text" name="address" class="input_box" value="<?php echo e($results->address); ?>"></i></h3>
                        <?php if($errors->has('address')): ?>
                        <br>
                        <p class="error-message"><?php echo e($errors->first('address')); ?></p>
                        <?php endif; ?>

                        <h3><i class="fa-solid fa-cable-car"></i>&emsp;<input type="text" name="genre" class="input_box" value="<?php echo e($results->genre); ?>"></i></h3>
                        <?php if($errors->has('genre')): ?>
                        <br>
                        <p class="error-message"><?php echo e($errors->first('genre')); ?></p>
                        <?php endif; ?>

                        <h3><textarea name="detail"><?php echo nl2br(e($results->detail)); ?></textarea></h3>
                        <?php if($errors->has('detail')): ?>
                        <br>
                        <p class="error-message"><?php echo e($errors->first('detail')); ?></p>
                        <?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\traveler\traveler\resources\views/administrator/touristarea_edit.blade.php ENDPATH**/ ?>