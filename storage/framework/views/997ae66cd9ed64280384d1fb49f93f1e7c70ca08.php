...
<body>
    ...
    <div class="administrator_user_edit_category">
        <ul>
            <form method="post" action="/user_edit_confirm">
                <?php echo csrf_field(); ?>
                <li>プロフィールの変更</li>
                <!--2-->
                <li></li>
...
</html><?php /**PATH C:\xampp\htdocs\traveler\resources\views/administrator/user_edit.blade.php ENDPATH**/ ?>