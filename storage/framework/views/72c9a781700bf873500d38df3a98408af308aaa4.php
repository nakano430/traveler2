        ...
        <ul>
            <form method="post" action="/password_reset_send">
                ...
                <li class="password_reset_button_form" id="top_delimiter">
                    <button type="submit" class="password_reset_button" name="send" onclick="clickEvent()">変更する</button>
                </li>
                <!--10-->
            </form>
...
</html><?php /**PATH C:\xampp\htdocs\Travel\resources\views/login/password_edit.blade.php ENDPATH**/ ?>