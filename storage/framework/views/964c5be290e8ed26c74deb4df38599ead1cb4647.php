...
<body>
    ...
    <div>
        <h1 class="detail_title"><?php echo e($hotel_info->name); ?></h1>
        <table class="detail_category">
            <tr>
                <td><img class="hotel_picture" src="img/hotel/<?php echo e($hotel_info->english_name); ?>.jpg"></td>
                <td class="detail_delimiter"></td>
                <td class="area_detail">
                    <h2>● ホテル詳細</h2>
                    <h3><i class="fa-solid fa-location-dot">&emsp;<?php echo e($hotel_info->address); ?></i></h3>
                    <h3><i class="fa-solid fa-phone">&emsp;<?php echo e($hotel_info->tel); ?></i></h3>
                    ...
                    <p>&emsp;・<?php echo e($room->roomtype); ?> / <?php echo e($room->price); ?>円</p>
        ...
        <div class="hotel_detail"><h3><?php echo e($hotel_info->detail); ?></h3></div>
...
</html><?php /**PATH C:\xampp\htdocs\traveler\traveler\resources\views/hotels/hotel_detail.blade.php ENDPATH**/ ?>