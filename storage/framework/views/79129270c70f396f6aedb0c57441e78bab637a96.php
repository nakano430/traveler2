...
<div class="profile_complete_category">
    <form method="POST" action="/itinerary_list">
        ...
        <?php echo csrf_field(); ?>
            ...
            <li>
                旅程表の削除が完了致しました。<br>
                "旅程表情報一覧へ戻る"ボタンにてお戻りください。
            </li>
            <li><button type="submit" class="back_login_button">旅程表情報一覧へ戻る</button></li>
...
</html><?php /**PATH /Applications/MAMP/htdocs/Travel/resources/views/delete/itinerary_delete.blade.php ENDPATH**/ ?>